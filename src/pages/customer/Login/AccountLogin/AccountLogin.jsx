...
//   function AccountLogin({ handleClose }) {
...
//  //set
// const {setMylogin,setCheckLogin} = useContext(ThemeContext);
//   //account
...
//           account: dataProductItem.account,
//           password: dataProductItem.password,
//           img: dataProductItem.img,
//           name: dataProductItem.name,
//           email: dataProductItem.email,
//           gender: dataProductItem.gender,
//           dateOfBirth: dataProductItem.dateOfBirth,
//           address:dataProductItem.address,
        
//         };
//         setCheckLogin((item) => [...item,newItems]);
//         setTimeout(() => {
//           setMylogin(true)
//         }, 3000);
